...
[
    ...
    new Result("Вот так и взорвался... Спасибо за внимание!", 42, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsoCFCsR_CfknzbAsfDfj-B38n8e215iqzcw&usqp=CAU'),
    new Result("Вот ты и попался в мою ловушку :)", 44, 'https://www.meme-arsenal.com/memes/c0ad6c7d57abf01c69db084bc29c5edf.jpg'),
    new Result("Чел, успокойся. Неужели хочешь 50 баллов?", 46, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTxlyBkHNvl0keOGEHcnCvPDNjx8Y1nyyOekQ&usqp=CAU'),
    new Result("Пиздим его ребят, у него дофига времени", 48, 'https://www.meme-arsenal.com/memes/15ce6db551634d1e09a0fe8644eaa46e.jpg'),
    new Result("Как же ты слаб в постиронии...", 50, 'https://sun9-18.userapi.com/impf/WpuF3-OaesG7rZVs8JHvdviqfh2RY312uXX9Iw/cds7TYYjLkk.jpg?size=604x446&quality=96&sign=1a2182544feae522012ccbf2dc6e3ead&type=album'),
];
...
[
    ...
    new Question("Почему новорожденные такие некрасивые?",
	[
		new Answer("Стирать было плохой идеей...", 0),
		new Answer("Пуля в голову была лишней", 0),
		new Answer("СПАРТАААА!!!", 1),
		new Answer("Потому что негр", 0)
	]),
    
    new Question("Как избавиться от жирного АХАХХАХА?",
	[
		new Answer("Уебав об стенку", 1),
		new Answer("Уебав об Генриха", 0),
		new Answer("Уебав об собаку", 0),
		new Answer("Уебав об кошку", 0)
	]),
    
    new Question("Каких размеров Specific Оcеаn?",
	[
		new Answer("Мелких капец, ты бы видел", 0),
		new Answer("Вот такой хуиты", 0),
		new Answer("Вот такой ширины, вот такой высоты", 0),
		new Answer("Быть может Specific?", 1)
	]),
    
    new Question("Моя жена изменила свой статус в Facebook с «замужем» на «вдова». Мне начинать волноваться?",
	[
		new Answer("Всё ок", 0),
		new Answer("Всё не ок", 0),
		new Answer("Пизда тебе нахуй", 1),
		new Answer("Тебе пиздец", 0)
	]),
    
    new Question("Мне 10 лет, и за последние 10 лет у меня было 18000 половых партнеров. Это нормально?",
	[
		new Answer("Генрих? Ты ли это?", 0),
		new Answer("А вот это уже вот это уже вот", 1),
		new Answer("Ну даже блять не знаю, а сам то как думаешь", 0),
		new Answer("Люблю кабачки, анон плз", 0)
	]),
    
    new Question("Мне кажется, что моя 5-летняя дочь занимается сексом. Что мне делать?",
	[
		new Answer("Помочь дочке", 0),
		new Answer("Ну ёбанный рот, опять что ли?", 0),
		new Answer("Да как же ты заебала бабка", 0),
		new Answer("Оставить дело профи", 1)
	]),
    
    new Question("Почему я чувствую, будто в моем животе порхает героин?",
	[
		new Answer("Оставь там, должно быть весело", 0),
		new Answer("ПОДСЕКАЙ ПОДСЕКАЙ", 1),
		new Answer("НЕ ПОДСЕКАЙ НЕ ПОДСЕКАЙ", 0),
		new Answer("Попробуй скурить", 0)
	]),
    
    new Question("Что лучше? Тимати или Фиксики?",
	[
		new Answer("Егор Крид", 0),
		new Answer("Нуждики", 1)
	]),
    
    new Question("Если я съем самого себя, я стану вдвое больше или просто исчезну?",
	[
		new Answer("Тебя схавают быстрее негры", 0),
		new Answer("Тебя негры быстрее схавают", 0),
		new Answer("Ты станешь вдвое меньше", 0),
		new Answer("Ты станешь втрое больше", 1)
	]),
    
    new Question("Как мне обмануть слона, чтобы заставить его искупаться в море?",
	[
		new Answer("Замани генрихами", 1),
		new Answer("Позови мартышек, они знают своё дело", 0),
		new Answer("Дай слону нюхнуть бебры", 0),
		new Answer("Дай бебре нюхнуть слона", 0)
	]),
];
